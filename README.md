...
A simple, serverless and fully reproducible birthday notification system using Telegram and GitHub Actions.

No backend, no database, no server — just a JSON file and automation.
-Python
-GitHub Actions
-Telegram Bot API
...
1. Edit `data/aniversariantes.json`
2. Set one entry to today's date (Bot...for example)
3. Go to **Actions**
